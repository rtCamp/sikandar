                    ...
                    List {
                        Section {
                            ...
                            HStack {
                                Text("Player")
                                Spacer()
                                Text("Games").frame(width: gamesCol, alignment: .center)
                                Text("Played").frame(width: roundsCol, alignment: .center)
                                Text("Wins").frame(width: winsCol, alignment: .center)
                                Text("Net").frame(width: netCol, alignment: .center)
                            }
                            .font(.caption.weight(.semibold))
                            .foregroundColor(.secondary)
                            ...
                            ForEach(stats, id: \.player.id) { s in
                                HStack {
                                    ...
                                    Spacer()
                                    Text("\(s.games)")
                                        .frame(width: gamesCol, alignment: .center)
                                    Text("\(s.rounds)")
                                        .foregroundColor(.secondary)
                                        .frame(width: roundsCol, alignment: .center)
                                    Text("\(s.wins)")
                                        .frame(width: winsCol, alignment: .center)
